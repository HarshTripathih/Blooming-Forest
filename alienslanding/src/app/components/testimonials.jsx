  ...
  return (
    <>
      <section className="w-full px-6 py-24 text-center relative 2xl:mb-10">
        ...
        <div className="absolute left-5 md:left-24 top-0 h-full z-0 hidden md:flex flex-row justify-between xxs:gap-[2.5rem] xs:gap-[2.9rem] sm:gap-[11rem] md:gap-[5rem] lg:gap-[11rem]  2xl:gap-[15rem]">
        {lines.map((line, i) => (
